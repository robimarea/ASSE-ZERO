import { useRef, ReactNode, memo, ElementType, ComponentPropsWithRef } from 'react';
...
export const Viewport = memo(({
  ...
  const ContainerTag = Component as ElementType<ComponentPropsWithRef<typeof Component>>;

  return (
    <ContainerTag
      ref={containerRef as ComponentPropsWithRef<typeof Component>['ref']}
      id={id}
      className={classes}
